...
export default function BuyFlow() {
  ...
  // 2. Fiat currency is NGN (OnRamp only supports NGN and ZAR)
  ...
  useEffect(() => {
    ...
    if (pendingTxn) {
      try {
        ...
        // Only resume if transaction was started less than 1 hour ago and is a BUY
        if (Date.now() - startTime < 3600000 && type === 'BUY') {
  ...
  const handleProceedToCheckout = async () => {
    ...
    try {
      ...
      if (providerName === 'ONRAMP') {
        ...
        console.log('OnRamp Buy Request:', payload);
        ...
        console.log('MoonPay Buy Request:', payload);
