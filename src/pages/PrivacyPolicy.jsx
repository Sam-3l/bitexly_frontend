    ...
    <div className="min-h-screen bg-white dark:bg-slate-900 transition-colors duration-300">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 pt-24 text-slate-800 dark:text-slate-200 leading-relaxed space-y-8">
        ...
        <div className="space-y-6">
          ...
          <h3 className="text-xl font-semibold">C. Third-Party Data</h3>
          <p>
          ...
          <h2 className="text-2xl font-semibold">5. Non-Custodial Nature</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold">13. Updates to This Policy</h2>
          <p>
